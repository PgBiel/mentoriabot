...
pub trait SelectComponent<Data> {
    fn create<'a>(builder: &'a mut serenity::CreateSelectMenu, data: &Data) -> (&'a mut serenity::CreateSelectMenu, CustomId);
...
pub trait ButtonComponent<Data> {
    fn create<'a>(builder: &'a mut serenity::CreateButton, data: &Data) -> (&'a mut serenity::CreateButton, CustomId);
...
pub trait ButtonsComponent<Data> {
    ...
    fn create<'a>(builder: &'a mut serenity::CreateActionRow, data: &Data) -> (&'a mut serenity::CreateActionRow, Vec<CustomId>);
