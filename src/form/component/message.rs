...
pub trait MessageFormComponent: Sync {
    ...
    async fn send_component(&self, context: ApplicationContext<'_>, custom_id: &str, form_data: Self::Form) -> Result<Self::Form>;

    async fn on_response(&self, context: ApplicationContext<'_>, interaction: Arc<serenity::MessageComponentInteraction>, form_data: Self::Form)
        -> Result<Self::Form>;
